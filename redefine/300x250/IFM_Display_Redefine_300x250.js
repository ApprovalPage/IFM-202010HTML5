...
(lib.thumbgreen = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.graphics.f("#007B9F").s().p("Ag8AbQgHhMANhfIAFgWQAIgGAGgLIALgXQBGCEAOBTQAXCDhaBDQgshPgJhlgAgzikIgDAUIgEANIgGATIANg0gAg2iQIAAAAg");
	...
	this.shape_4.graphics.f("#007B9F").s().p("AHVBmQhXgQg3gDQApANg/gOIAWABIg8gRQiCgkCoA0QjIgqiSgQQi7gViqALQg0AChEgRQhKgXgngIQFWh5FYAnQFjApDeDFQg3gBhsgVg");
...
}).prototype = getMCSymbolPrototype(lib.thumbgreen, new cjs.Rectangle(-0.1,0,749.7,915.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// bkgd-pattern
	this.instance_5 = new lib.thumbgreen();
...
p.nominalBounds = new cjs.Rectangle(-382.8,-430.7,1122.5,1429);
// library properties:
lib.properties = {
